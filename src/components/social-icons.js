...
function SocialIcons() {
  return (
    <>
      ...
      <SocialIcon name="GitHub" url="https://github.com/KwatME">
      ...
      <SocialIcon name="Podcast" url="https://anchor.fm/Kwat">
      ...
      <SocialIcon name="Twitter" url="https://twitter.com/KwatME">
        <i className="fab fa-twitter"></i>
      </SocialIcon>

      <SocialIcon name="Instagram" url="https://www.instagram.com/Kwat.ME">
